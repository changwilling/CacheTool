...
/**
 * Created by changwilling on 17/4/1.
 * 文件工具类
 */
...
public class FileUtil {
    ...
    public static File getExternalCacheDirectory(Context context, String type) {
        ...
        if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())) {
            ...
            LogUtil.e("getExternalDirectory", "getExternalDirectory fail ,the reason is sdCard nonexistence or sdCard " +
                    "mount fail !");
        }
        return appCacheDir;
    }
     ...
     * 根据url加密生成唯一文件名
     */
    public static String getFileNameByUrlWithEncode(String url){
        String cacheKey;
        try {
